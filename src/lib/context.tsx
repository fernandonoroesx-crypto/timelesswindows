...
export const DEFAULT_PRICING: PricingData = {
  ...
  makingGoodSelling: { internal: 65.00, external: 20.00 },
  makingGoodCost: { internal: 35.00, external: 10.00 },
  architraveSelling: 6.50,
  architraveCost: 4.50,
  trimsSelling: 4.00,
  trimsCost: 1.00,
  mdfSelling: { singleNarrow: 9.00, sideNarrow: 9.00, centralNarrow: 9.00, singleWide: 18.00, sideWide: 18.00, centralWide: 18.00 },
  mdfCost: { singleNarrow: 5.00, sideNarrow: 5.00, centralNarrow: 5.00, singleWide: 10.00, sideWide: 10.00, centralWide: 10.00 },
