...
export const DEFAULT_PRICING: PricingData = {
  ...
  extrasSelling: { 'Recess of reveal': 75, 'Shutters': 100, 'Cut Out of work top': 125 },
  extrasCost: { 'Recess of reveal': 75, 'Shutters': 100, 'Cut Out of work top': 125 },
  consumables: {
...
export function createNewLineItem(): QuoteLineItem {
  return {
    ...
    widthMm: 0,
    heightMm: 0,
    manufactureCurrency: 'EUR',
    supplier: 'Staliu Gaminiai',
    manufacturePrice: 0,
    uplift: 0,
