...
export default function PricingEditor({ pricing, onUpdate, compact }: PricingEditorProps) {
  ...
  return (
    <div className={`grid gap-4 ${compact ? 'lg:grid-cols-2' : 'lg:grid-cols-2 gap-6'}`}>
      <div className={cardClass}>
        <h3 className="font-heading text-sm font-semibold mb-3">Installation — Selling</h3>
      ...
      <div className={cardClass}>
        <h3 className="font-heading text-sm font-semibold mb-3">Making Good — Selling</h3>
        <div className="space-y-2">
      ...
      <div className={cardClass}>
        ...
        <div className="space-y-2">
          <EditRow label="Architrave (selling)" value={pricing.architraveSelling} path="architraveSelling" onUpdate={onUpdate} />
          <EditRow label="Architrave (cost)" value={pricing.architraveCost} path="architraveCost" onUpdate={onUpdate} />
          <EditRow label="Trims (selling)" value={pricing.trimsSelling} path="trimsSelling" onUpdate={onUpdate} />
          <EditRow label="Trims (cost)" value={pricing.trimsCost} path="trimsCost" onUpdate={onUpdate} />
          <EditRow label="MDF Narrow (selling)" value={pricing.mdfSelling.narrow} path="mdfSelling.narrow" onUpdate={onUpdate} />
          <EditRow label="MDF Narrow (cost)" value={pricing.mdfCost.narrow} path="mdfCost.narrow" onUpdate={onUpdate} />
          <EditRow label="MDF Wide (selling)" value={pricing.mdfSelling.wide} path="mdfSelling.wide" onUpdate={onUpdate} />
          <EditRow label="MDF Wide (cost)" value={pricing.mdfCost.wide} path="mdfCost.wide" onUpdate={onUpdate} />
        </div>
      </div>
      <div className={cardClass}>
        <h3 className="font-heading text-sm font-semibold mb-3">Other Costs</h3>
        <div className="space-y-2">
